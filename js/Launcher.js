...
/*
valCheckBox[1].addEventListener('change', (event) => {
    if(event.target.checked){
        g_changeIdx.push(1);
        g_numChange++;
    }
    else if(!event.target.checked){        
        g_changeIdx.splice(g_changeIdx.indexOf(1), 1);
        g_numChange--;
    }
    console.log(g_changeIdx);
});
valCheckBox[2].addEventListener('change', (event) => {
    if(event.target.checked){
        g_changeIdx.push(2);
        g_numChange++;
    }
    else if(!event.target.checked){
        g_changeIdx.splice(g_changeIdx.indexOf(2), 1);
        g_numChange--;
    }
    console.log(g_changeIdx);
});
valCheckBox[3].addEventListener('change', (event) => {
    if(event.target.checked){
        g_changeIdx.push(3);
        g_numChange++;
    }
    else if(!event.target.checked){
        g_changeIdx.splice(g_changeIdx.indexOf(3), 1);
        g_numChange--;
    }
    console.log(g_changeIdx);
});
valCheckBox[4].addEventListener('change', (event) => {
    if(event.target.checked){
        g_changeIdx.push(4);
        g_numChange++;
    }
    else if(!event.target.checked){
        g_changeIdx.splice(g_changeIdx.indexOf(4), 1);
        g_numChange--;
    }
    console.log(g_changeIdx);
});
